...
if __name__ == '__main__':
    ...
    model = net
    model.eval()
    load_model_path_i = os.path.join(save_dir, '20210511_142559kfold_may5_revised_crop1_725_aug_p_0_attri_7_8resnext101_32x8d_101pretrain-Falsesize224_1' ,'model_param.pkl') #20210511_142559kfold_may5_revised_crop1_725_aug_p_0_attri_7_8resnext101_32x8d_101pretrain-Falsesize224_1
#'20210418_164709part0_apr18_revised_crop_1_725_train_aug_only_2_p_0.2_78resnext101_32x8d_101pretrain-False'
    ...
    for patient_id in range(300,800):
        ...
        for tooth_id in ['11','12','21','22']:
            ...
            for file_name in os.listdir(img_dir):
                if not (file_name.endswith('tif') and file_name.startswith('cropped_image{}'.format(patient_id)) and ',' in file_name and  \
                ...
                output_path = os.path.join("/data/shimr/visual/",patient_id, tooth_id)#os.path.join("/data/shimr/visual/",patient_id, tooth_id)
